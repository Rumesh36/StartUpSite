...
const ServiceCards = ({logo,title,description}) => {
  return (
    <>
    ...
    <div className="bg-white shadow-lg border border-gray-200 w-[350px] rounded-2xl p-6 hover:shadow-2xl transition-shadow duration-300">
      ...
      <div className="flex items-center gap-4 mb-4">
        <div className="w-12 h-12 flex items-center justify-center bg-gradient-to-r from-blue-300 to-blue-400 text-white font-bold text-xl rounded-xl">
          {logo}
        </div>
